...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void conn_btn_Click(object sender, EventArgs e)
        {
            ...
            try {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/connection/" + port);
                request.Method = "GET";
                ...
                {
                    Console.WriteLine("RESPONSE FAIL : " + response.StatusCode);
                }
            }
            catch (Exception ex) 
            {
        ...
        private void recvLedInfo(object sender, DoWorkEventArgs e)
        {
            ...
            {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/message/led");
                request.Method = "GET";
                request.ContentType = "application/json";
                //request.Timeout = 30 * 1000;
                HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        private void recvTmpInfo(object sender, DoWorkEventArgs e)
        {
            ...
            {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/message/tmp");
                request.Method = "GET";
                request.ContentType = "application/json";
                //request.Timeout = 30 * 1000;
                HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        private void recvLightInfo(object sender, DoWorkEventArgs e)
        {
            ...
            {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/message/light");
                request.Method = "GET";
                request.ContentType = "application/json";
                //request.Timeout = 30 * 1000;
                HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        private void recvDistanceInfo(object sender, DoWorkEventArgs e)
        {
            ...
            {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/message/distance");
                request.Method = "GET";
                request.ContentType = "application/json";
                //request.Timeout = 30 * 1000;
                HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        {
            HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/led/1");
            request.Method = "GET";
            request.ContentType = "application/json";
            //request.Timeout = 30 * 1000;
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        {
            HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://192.168.2.254:8080/arduino/led/0");
            request.Method = "GET";
            request.ContentType = "application/json";
            //request.Timeout = 30 * 1000;
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
